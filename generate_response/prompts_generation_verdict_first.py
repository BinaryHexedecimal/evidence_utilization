...
def generate_prompt_with_verdict_first(df, num_support_evidence: int, 
    ...
    for _, row in df.iterrows():
        ...
        prompt_lines_basic.append(
            ...
            "Then summarize the key factual insights (3–7 bullet points) that are " 
            ...
            "4. Avoid meta-references (e.g., 'the claim states', 'the evidence shows') within the bullet points. "  
            "5. Internal knowledge refers to whether you use any internal knowledge beyond the provided evidence when producing the bullet points. "          
        ...
        prompt_lines_claim.append(
            ...
            "4. Avoid meta-references (e.g., 'the claim states') within the bullet points. "  
            "5. Internal knowledge refers to whether you use any internal knowledge when producing the bullet points. "
