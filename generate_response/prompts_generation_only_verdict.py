...
def generate_prompt_with_only_verdict(df, num_support_evidence: int, 
    ...
    for _, row in df.iterrows():
        ...
        prompt_lines_basic.append(
            ...
            "Rules:"          
            "1. Your response MUST contain only one word (the verdict) in lowercase, exactly one of: true, false, or maybe. "
            "2. Do NOT include any punctuation, explanation, formatting, or extra text. "
            "3. Use maybe as verdict ONLY if the provided evidence contains contradiction OR is insufficient to favor either true or false. "        
        ...
        prompt_lines_internal.append(
            ...
            "1. Your response MUST contain only one word (the verdict) in lowercase, exactly one of: true, false, or maybe. "
            "2. Do NOT include any punctuation, explanation, formatting, or extra text. "
            "3. Use maybe as verdict ONLY if the provided evidence contains contradiction AND your internal knowledge also fails to favor either true or false. "
        ...
        prompt_lines_claim.append(
            ...
            "1. Your response MUST contain only one word (the verdict) in lowercase, exactly one of: true, false, or maybe. "
            "2. Do NOT include any punctuation, explanation, formatting, or extra text. "
            "3. Use maybe as verdict ONLY if your internal knowledge fails to favor either true or false. "
